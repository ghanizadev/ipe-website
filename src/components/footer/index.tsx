...
export default async function Footer() {
    ...
    return (
        <footer className="w-full bg-gray-800 text-white">
            <div
                className={"max-w-screen-xl mx-auto px-8 py-16 grid grid-cols-2 grid-rows-1 gap-8 min-h-96 lg:gap-24"}>
                <div>
                    <p className={"font-bold mb-6"}>IPE - Inclusao pelo esporte</p>
                    <p className={"text-gray-400 mb-2"}>Mussum Ipsum, cacilds vidis litro abertis. Casamentiss faiz
                        malandris
                        se
                        pirulitá. Negão é teu
                        passadis, eu sou faxa pretis. Copo furadis é disculpa de bebadis, arcu quam euismod magna.
                        Mauris
                ...
                <div className={"mt-8"}>
                    <ul>
                        <li className={"mb-2"}>
                            <a href={"https://www.instagram.com/ipe_paratletascorredores"}
                               target={'_blank'}
